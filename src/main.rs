                ...
                Ok(input) => {
                    ...
                    for line in pest {
                        match line.as_rule() {
                            ...
                            Rule::binvarassign => {
                                println!("binvarassign: {}", line.as_span().as_str())
                            }
                            Rule::intvarassign => {
                                println!("intvarassign: {}", line.as_span().as_str())
                            }
                            Rule::hexvarassign => {
                                println!("hexvarassign: {}", line.as_span().as_str())
                            }
                            Rule::octvarassign => {
                                println!("octvarassign: {}", line.as_span().as_str())
                            }
