...
impl Opt {
    ...
    pub fn init_shopt_options() -> Opt {
        ...
        options.set("autocd".to_string(), OptionRW { set: false, rw: true });
        // If set, an argument to the cd builtin command that is not a directory is assumed to be the name of a variable whose value is the directory to change to.
        options.set("cdable_vars".to_string(), OptionRW { set: false, rw: true });
        ...
        options.set("cdspell".to_string(), OptionRW { set: false, rw: true });
        ...
        options.set("checkhash".to_string(), OptionRW { set: false, rw: true });
        ...
        options.set("checkjobs".to_string(), OptionRW { set: false, rw: true });
        // If set, rush checks the window size after each command and, if necessary, updates the values of LINES and COLUMNS.
        options.set("checkwinsize".to_string(), OptionRW { set: true, rw: true });
        ...
        options.set("cmdhist".to_string(), OptionRW { set: true, rw: true });
        ...
        options.set("compat31".to_string(), OptionRW { set: false, rw: true });
        ...
        options.set("compat32".to_string(), OptionRW { set: false, rw: true });
        ...
        options.set("compat40".to_string(), OptionRW { set: false, rw: true });
        ...
        options.set("compat41".to_string(), OptionRW { set: false, rw: true });
        ...
        options.set("compat42".to_string(), OptionRW { set: false, rw: true });
        ...
        options.set("complete_fullquote".to_string(), OptionRW { set: true, rw: true });
        ...
        options.set("direxpand".to_string(), OptionRW { set: false, rw: true });
        ...
        options.set("dirspell".to_string(), OptionRW { set: false, rw: true });
        // If set, rush includes filenames beginning with a `.' in the results of pathname expansion.
        options.set("dotglob".to_string(), OptionRW { set: false, rw: true });
        ...
        options.set("execfail".to_string(), OptionRW { set: false, rw: true });
        // If set, aliases are expanded as described above under ALIASES.  This option is enabled by default for interactive shells.
        options.set("expand_aliases".to_string(), OptionRW { set: true, rw: true });
        ...
        options.set("extdebug".to_string(), OptionRW { set: false, rw: true });
        // If set, the extended pattern matching features described above under Pathname Expansion are enabled.
        options.set("extglob".to_string(), OptionRW { set: true, rw: true });
        // If set, $'string' and $"string" quoting is performed within ${parameter} expansions enclosed in double quotes.  This option is enabled by default.
        options.set("extquote".to_string(), OptionRW { set: true, rw: true });
        // If set, patterns which fail to match filenames during pathname expansion result in an expansion error.
        options.set("failglob".to_string(), OptionRW { set: false, rw: true });
        ...
        options.set("force_fignore".to_string(), OptionRW { set: true, rw: true });
        ...
        options.set("globasciiranges".to_string(), OptionRW { set: false, rw: true });
        // If  set, the pattern ** used in a pathname expansion context will match all files and zero or more directories and subdirectories.  If the pattern is followed by a /, only directories and subdirectories match.
        options.set("globstar".to_string(), OptionRW { set: false, rw: true });
        // If set, shell error messages are written in the standard GNU error message format.
        options.set("gnu_errfmt".to_string(), OptionRW { set: false, rw: true });
        // If set, the history list is appended to the file named by the value of the HISTFILE variable when the shell exits, rather than overwriting the file.
        options.set("histappend".to_string(), OptionRW { set: true, rw: true });
        // If set, and readline is being used, a user is given the opportunity to re-edit a failed history substitution.
        options.set("histreedit".to_string(), OptionRW { set: false, rw: true });
        // If set, and readline is being used, the results of history substitution are not immediately passed to the shell parser. Instead, the resulting line is loaded into the readline editing buffer, allowing further modification.
        options.set("histverify".to_string(), OptionRW { set: false, rw: true });
        ...
        options.set("hostcomplete".to_string(), OptionRW { set: true, rw: true });
        // If set, rush will send SIGHUP to all jobs when an interactive login shell exits.
        options.set("huponexit".to_string(), OptionRW { set: false, rw: true });
        ...
        options.set("interactive_comments".to_string(), OptionRW { set: true, rw: true });
        // If set, and job control is not active, the shell runs the last command of a pipeline not executed in the background in the current shell environment.
        options.set("lastpipe".to_string(), OptionRW { set: false, rw: true });
        ...
        options.set("lithist".to_string(), OptionRW { set: false, rw: true });
        // The shell sets this option if it is started as a login shell (see INVOCATION above). The value may not be changed.
        options.set("login_shell".to_string(), OptionRW { set: false, rw: true });
        ...
        options.set("mailwarn".to_string(), OptionRW { set: false, rw: true });
        ...
        options.set("no_empty_cmd_completion".to_string(), OptionRW { set: false, rw: true });
        // If set, rush matches filenames in a case-insensitive fashion when performing pathname expansion.
        options.set("nocaseglob".to_string(), OptionRW { set: false, rw: true });
        ...
        options.set("promptvars".to_string(), OptionRW { set: true, rw: true });
        ...
        options.set("restricted_shell".to_string(), OptionRW { set: false, rw: true });
        // If set, the shift builtin prints an error message when the shift count exceeds the number of positional parameters.
        options.set("shift_verbose".to_string(), OptionRW { set: false, rw: true });
        // If set, the source (.) builtin uses the value of PATH to find the directory containing the file supplied as an argument. This option is enabled by default.
        options.set("sourcepath".to_string(), OptionRW { set: true, rw: true });
        // If set, the echo builtin expands backslash-escape sequences by default.
        options.set("xpg_echo".to_string(), OptionRW { set: false, rw: true });
        options
    }
    ...
    pub fn init_set_options() -> Opt {
        ...
        options.set("allexport".to_string(), OptionRW { set: false, rw: true });
        options.set("braceexpand".to_string(), OptionRW { set: true, rw: true });
        options.set("emacs".to_string(), OptionRW { set: false, rw: true });
        options.set("errexit".to_string(), OptionRW { set: false, rw: true });
        options.set("errtrace".to_string(), OptionRW { set: false, rw: true });
        options.set("functrace".to_string(), OptionRW { set: false, rw: true });
        options.set("hashall".to_string(), OptionRW { set: true, rw: true });
        options.set("histexpand".to_string(), OptionRW { set: true, rw: true });
        options.set("history".to_string(), OptionRW { set: false, rw: true });
        options.set("ignoreeof".to_string(), OptionRW { set: false, rw: true });
        options.set("interactive-comments".to_string(), OptionRW { set: false, rw: true });
        options.set("keyword".to_string(), OptionRW { set: false, rw: true });
        options.set("monitor".to_string(), OptionRW { set: true, rw: true });
        options.set("noclobber".to_string(), OptionRW { set: false, rw: true });
        options.set("noexec".to_string(), OptionRW { set: false, rw: true });
        options.set("noglob".to_string(), OptionRW { set: false, rw: true });
        options.set("nolog".to_string(), OptionRW { set: false, rw: true });
        options.set("notify".to_string(), OptionRW { set: false, rw: true });
        options.set("nounset".to_string(), OptionRW { set: false, rw: true });
        options.set("onecmd".to_string(), OptionRW { set: false, rw: true });
        options.set("physical".to_string(), OptionRW { set: false, rw: true });
        options.set("pipefail".to_string(), OptionRW { set: false, rw: true });
        options.set("posix".to_string(), OptionRW { set: false, rw: true });
        options.set("privileged".to_string(), OptionRW { set: false, rw: true });
        options.set("verbose".to_string(), OptionRW { set: false, rw: true });
        options.set("vi".to_string(), OptionRW { set: false, rw: true });
        options.set("xtrace".to_string(), OptionRW { set: false, rw: true });
        options
    }
}
